...
var components = map[string]component{
	...
	"transfer-operator":           {"transfer-operator/v", "transfer-operator.yml: builds + signs the image, cuts a GitHub release, bumps the chart, publishes SBOM + signed OCM component"},
